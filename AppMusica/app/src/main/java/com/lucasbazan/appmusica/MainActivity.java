package com.lucasbazan.appmusica;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void reproducir(View view){
        ...
        if (radio6.isChecked()) {
            ...
            try {
                mediaPlayer.setDataSource("https://tajysoftware.com/assets/mp3/pista6.mp3");
                mediaPlayer.prepare();
            } catch (IOException e) {
            }
        }
        if (radio7.isChecked()) {
            mediaPlayer=new MediaPlayer();
            try {
                mediaPlayer.setDataSource("https://tajysoftware.com/assets/mp3/pista7.mp3");
                mediaPlayer.prepare();
            } catch (IOException e) {
            }
        }
